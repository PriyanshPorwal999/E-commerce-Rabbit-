...
const selectedProduct = {
  ...
  price: 120,
  originalPrice: 150,
  description: "This is a stylish Jacket perfect fro any occasion",
  brand: "FashionBrand",
  material: "Leather",
  sizes: ["S", "M", "L", "XL"],
  colors: ["Red", "Black"],
  images: [
    {
      ...
      altText: "Styish Jacket 1",
    },
    {
      url: "https://picsum.photos/500/500?random=2",
      altText: "Styish Jacket 2",
    },
  ],
};

// For Product Grid component
  ...
  return (
    <div className="p-6 bg-amber-300">
      <div className="max-w-6xl mx-auto bg-white p-8 rounded-lg">
        ...
        {/* Product Grid Componet || You may also like section call */}
        <div className="mt-20">
